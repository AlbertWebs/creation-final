...
class AdminsController extends Controller
{
    ...
    public function index(){
        ...
        $page_name = 'Dashboard';
        return view('admin.dashboard.index',compact('page_name','Comments','Message'));
    }
    ...
    public function add_Slider(Request $request){
        ...
        $filename = str_replace(' ', '', $file->getClientOriginalName());
        $timestamp = new \DateTime();
        $new_timestamp = $timestamp->format('Y-m-d H_i_s'); // Use underscores for time
        $image_main_temp = $new_timestamp . 'image' . $filename;
        $sanitized_filename = str_replace([' ', ':'], ['', '_'], $image_main_temp); // Ensure no spaces or colons
        $file->move($path, $sanitized_filename);
        $image = $sanitized_filename;
        $Slider = new Slider;
        ...
        if(isset($request->image_two)){
            $fileSize = $request->file('image_two')->getClientSize();
             if($fileSize>=1800000){
                ...
                $new_timestamp = $timestamp->format('Y-m-d H:i:s');
                $image_main_temp = $new_timestamp.'image'.$filename;
                $image_two = str_replace([' ', ':'], ['', '_'], $image_main_temp);
        ...
        if(isset($request->image_three)){
            ...
            if($fileSize>=1800000){
               ...
               Session::flash('messageError', "An error occured, You may have exceeded the maximum size for an image you uploaded");
                ...
                $new_timestamp = $timestamp->format('Y-m-d H:i:s');
                $image_main_temp = $new_timestamp.'image'.$filename;
                $image_three = str_replace([' ', ':'], ['', '_'], $image_main_temp);
        ...
        if(isset($request->image_four)){
            ...
            if($fileSize>=1800000){
               ...
               Session::flash('messageError', "An error occured, You may have exceeded the maximum size for an image you uploaded");
                ...
                $new_timestamp = $timestamp->format('Y-m-d H:i:s');
                $image_main_temp = $new_timestamp.'image'.$filename;
                $image_four = str_replace([' ', ':'], ['', '_'], $image_main_temp);
        ...
        if(isset($request->image_five)){
            ...
            if($fileSize>=1800000){
               ...
               Session::flash('messageError', "An error occured, You may have exceeded the maximum size for an image you uploaded");
                ...
                $new_timestamp = $timestamp->format('Y-m-d H:i:s');
                $image_main_temp = $new_timestamp.'image'.$filename;
                $image_five = str_replace([' ', ':'], ['', '_'], $image_main_temp);
...
public function add_Portfolio(Request $request){
    ...
    if(isset($request->image_one)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_one = str_replace([' ', ':'], ['', '_'], $image_main_temp);
            $file->move($path, $image_one);
    ...
    if(isset($request->image_six)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_six = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_seven)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_seven = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_eight)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_eight = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_nine)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_nine = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_ten)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_ten = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_eleven)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_eleven = str_replace([' ', ':'], ['', '_'], $image_main_temp);
    ...
    if(isset($request->image_twelve)){
            ...
            $new_timestamp = $timestamp->format('Y-m-d H:i:s');
            $image_main_temp = $new_timestamp.'image'.$filename;
            $image_twelve = str_replace([' ', ':'], ['', '_'], $image_main_temp);
