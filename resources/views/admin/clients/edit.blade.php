...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-600 mt-1">Update client details</p>
        </div>
        ...
        <form action="{{ route('admin.clients.update', $client) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="number" id="orders" name="orders" value="{{ old('orders', $client->orders ?? 10) }}" min="0" 
                ...
                <div>
                    ...
                    @if($client->image)
                        <div class="mb-2">
                            <img src="{{ url('/uploads/clients/' . $client->image) }}" alt="Current logo" class="w-32 h-32 object-contain rounded-lg bg-gray-100 p-2">
                        </div>
                    @endif
            ...
            <div class="mt-6 flex items-center justify-end space-x-4">
                ...
                <button type="submit" class="admin-btn-primary">Update Client</button>
            </div>
        </form>
    </div>
</div>
